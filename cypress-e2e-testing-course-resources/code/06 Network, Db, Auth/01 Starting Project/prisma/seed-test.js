...
export async function seed() {
  ...
  await prisma.takeaway.create({
    data: {
      ...
      body: "TEST Your commands (e.g., cy.get()) don't run immediately. They are scheduled to run at some point in the future.",
    },
  })
  await prisma.takeaway.create({
    data: {
      title: "Cypress acts on subjects",
      body: "TEST You can use then() to get direct access to the subject (e.g., HTML element, stub) of the previous command.",
    },
  })
}
